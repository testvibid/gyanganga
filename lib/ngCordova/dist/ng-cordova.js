...
// install   :    cordova plugin add cordova-plugin-sim
// link      :    https://github.com/pbakondy/cordova-plugin-sim

angular.module('ngCordova.plugins.sim', [])

  .factory('$cordovaSim', ['$q', function ($q) {

    return {
      simInfo: function (options) {
        var q = $q.defer();
